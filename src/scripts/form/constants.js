export const lines = [
  ...
  `After schooling in the nineties, I am so fucking glad we've stopped obsessing over academic circle-jerks like “what is 
postmodernism?”`,
  ...
  `Language wears the world like a shell, the world is the shape language expands to fill, and so we get the words we deserve: mass shooting, cointelpro, apparatchik, tourniquet—
but also canticle, lilac, solace.`,
  ...
  `And in the end, there is the final form, the one we become without knowing, the one that we no longer allow each other, the pleasure of digging into the earth, the joy of shovelling the earth closed again, over one another, an elemental 
interlacing so like, I must imagine, the way our parents, and we ourselves, pulled the covers over the stilling body of the exhausted child.`,
