...
export default function CreativeWriting() {
  return (
    <main className="page-content">
      ...
      <p>
        “I'm so glad this book exists—for what it means not only to me to read
        it now, but for what it will mean to others who are looking for a way
        into vispo that speaks to them and their lives. I love that it exists
        ...
        <br />
        <br />
        “Dani Spinosa's latest book of poetry is a collection of glosas that is
        conceptually radical, formally daring, and stylistically wonderful—as
        smart and imaginative as anything one should by now expect of Spinosa.”{" "}
        <strong>
      ...
      <p>
        “The fifty typewriter poems in this volume are both thought provoking
      ...
      <p>
        ...
        visual and concrete poetry as well as a collection of original works…
        She's clearly done her research, and if one were even to put together an
        anthology of or essay on the history of concrete and visual poetries,
        this would be the list of names included. Or, given Spinosa's deliberate
        inclusion of these multiple women practitioners, this is the list of
      ...
      <p>
        ...
        or over her sources. As she acknowledges in the introduction, even
        quoting a line from a concrete poem, much less an entire quatrain, can
        prove difficult as visual forms tend to challenge the convention of the
        line, but she more than manages this feat. The poems in the collection
        capture the aesthetics, the feel, of the texts they reference. Perhaps
        more importantly though, Spinosa's intervention in those texts unifies
        them.&nbsp;<em>OO</em>&nbsp;reads as a collection not an anthology with
        its poet, in the spirit of the glosa, paying tribute to influences and
        inspiration.” <strong>Ryan J. Cox, Prairie Fire</strong>
      </p>

      <p>
        “Dani Spinosa's OO pushes buttons, turns keys, and swipes, steals and
        homages all over poetry. Every poem demands you LOOK AGAIN! and see
        where voices slip between the keystrokes. Extravagant, interruptive,
        declarative and a real kick in the eyeballs.”{" "}
        <strong>derek beaulieu</strong>
      </p>

      <p>
        “WTF does Dani Spinosa think she is doing copying all these (mostly)
        male poets? Lock up your typewriters! Hide your anthologies of classic
        visual poetry! Protect yourself and the literary tradition from the
        stealth interventions of Spinosa, who is (mis)appropriating works by
        every conceivable author of graphically scored verse in the name of some
        kind of femmeship that involves conversations with the dead as well as
        the living. The former are silent on the matter and the latter? We shall
        see. Rarely has mimicry been used to such high-level hermeneutic ends.”{" "}
        <strong>Johanna Drucker</strong>
      </p>
      ...
      <ul className="bullet-list">
        ...
        <li>
          Mandrake, Jill. “
          <a href="https://www.geist.com/fact/reviews/unity-order-equilibr/ium/">
        ...
        <li>
          Laliberte, Mark. “
          <a href="http://blog.carouselmagazine.ca/usereview003/">
        ...
        <li>
          Hajnoczky, Helen. “
          <a href="https://www.ateacozyisasometimes.com/blog/2020/4/30/229mn1s4ah8xrzknyqlmupb2ila3kn">
            OOH My Heart
          </a>
          .” <em>A Tea Cozy is a Sometimes</em>, 1 May.
        </li>
        <li>
          Beattie, Stephen. “In her new collection, Dani Spinosa locates visual
          poetry at the nexus of analogue and digital traditions.”{" "}
          <em>Quill &amp; Quire</em>, 2 June.
        </li>
        <li>
          Beattie, Stephen. “<em>OO: Typewriter Poems</em>.”{" "}
          <em>Quill &amp; Quire</em>, vol. 86, iss. 1, Febr/uary 2020, p. 18.
        </li>
        <li>
          Ball, Jonathan. “
        ...
        <li>
          CBC Books. “
          <a href="https://www.cbc.ca/books/oo-typewriter-poems-1.5482144">
      ...
      <ul className="bullet-list">
        ...
        <li>
          “Table of Contents (for Gary Barwin).” Spectral Lines, An anthology of
          visual poems, edited by Kyle Flemmer. League of Canadian Poets.
        </li>
        <li>
        ...
        <li>
          “New Noise.” <em>Report from the Siklosi Society</em>, edited by rob
          mclennan, 2022.
        </li>
        <li>
          <a
        ...
        <li>
          “Noi Peccatori.” <em>Report from the Earl Society</em>, edited by rob
          mclennan.
        </li>
        <li>
          “I am Here” and “See No Ideas, Hear No Ideas.”{" "}
          <em>14 Ways of Being Kinder to the Earth</em>, edited by Gregory Betts
          and derek beaulieu, pp. 14-15 (co-authored with Marianne Holm Hansen).
          2021
        </li>
        <li>
          <a
        ...
        <li>
          “Shadows Cast by Moonlight.” <em>Incantations</em>, visual poem with
          audio spell accompaniment by Gavilan Rayna Russom. Séance Centre. 2021
        </li>
        <li>
        ...
        <li>
          ...
          <em>Explorations in Media Ecology</em>, ed. Adeena Karasick, vol. 20,
          no. 2, 2021
        </li>
        <li>
          “Nausicaa” and “Glauke.” <em>Belfield Literary Review</em>, edited by
          Gregory Betts and
          <br />
          Lucy Collins, 2021
        </li>
        ...
        <li>
          “Simply Black and White (5 Poems).” <em>Exile Quarterly</em>, vol. 43,
          iss. 3, 2020, pp. 69-73.
        </li>
        <li>
        ...
        <li>
          “Two Visual Poems.” <em>Not Your Best</em>, edited by Eric Schmaltz
          for knife|fork|book, 2019
        </li>
        <li>
          “I'm a nation, too.” <em>Here Comes Everyone: An Instanthology</em>,
          edited by Andrew MacEwan, p. 24, 25 April 2019
        </li>
        <li>
        ...
        <li>
          “Selections from <em>Betical</em> for Jon.” <em>ToCall</em>, vol. 3,
          p. 3, March, 2019
        </li>
        <li>
        ...
        <li>
          “Two Shots.” <em>Canadian Literature</em>, no. 230-231, Autumn/Winter
          2017, p. 248.
        </li>
        <li>
        ...
        <li>
          “Yeah Right,”{" "}
          <em>Resist Much/Obey Little: Inaugural Poems to the Resistance,</em>{" "}
      ...
      <ul className="bullet-list">
        ...
        <li>
          “Riddle” and “Fill Up.” <em>Concrete is Porous</em>, Secret Handshake
