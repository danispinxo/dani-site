...
export default function CreativeWriting() {
  return (
    <main className="page-content">
      ...
      <p>
        “I'm so glad this book exists—for what it means not only to me to read it now, but for what it will mean to others who are looking
        for a way into vispo that speaks to them and their lives. I love that it exists for the people who are going to be totally blown
        away by Spinosa and Siklosi's conversation, having never read anything quite like that before. This book is a real gift to vispo,
        its fans and present and future practitioners.”{' '}
        <strong>
      ...
      <p>
        “This collection is both Spinosa's personal study in the history of visual and concrete poetry as well as a collection of original
        works… She's clearly done her research, and if one were even to put together an anthology of or essay on the history of concrete and
        visual poetries, this would be the list of names included. Or, given Spinosa's deliberate inclusion of these multiple women
        practitioners, this is the list of names that should be included; and hopefully, in part through Spinosa's work, a list of names
        that will no longer be overlooked.” <strong>rob mclennan</strong>
      </p>
      <p>
        “Because the glosa, which builds a highly structured rhyming poem around a seed quatrain from a source text, is firmly rooted in the
        lyric, Spinosa has to find other ways to both quote and write through or around or over her sources. As she acknowledges in the
        introduction, even quoting a line from a concrete poem, much less an entire quatrain, can prove difficult as visual forms tend to
        challenge the convention of the line, but she more than manages this feat. The poems in the collection capture the aesthetics, the
        feel, of the texts they reference. Perhaps more importantly though, Spinosa's intervention in those texts unifies them.&nbsp;
        <em>OO</em>&nbsp;reads as a collection not an anthology with its poet, in the spirit of the glosa, paying tribute to influences and
        inspiration.” <strong>Ryan J. Cox, Prairie Fire</strong>
      </p>

      <p>
        “Dani Spinosa's OO pushes buttons, turns keys, and swipes, steals and homages all over poetry. Every poem demands you LOOK AGAIN!
        and see where voices slip between the keystrokes. Extravagant, interruptive, declarative and a real kick in the eyeballs.”{' '}
        <strong>derek beaulieu</strong>
      </p>

      <p>
        “WTF does Dani Spinosa think she is doing copying all these (mostly) male poets? Lock up your typewriters! Hide your anthologies of
        classic visual poetry! Protect yourself and the literary tradition from the stealth interventions of Spinosa, who is
        (mis)appropriating works by every conceivable author of graphically scored verse in the name of some kind of femmeship that involves
        conversations with the dead as well as the living. The former are silent on the matter and the latter? We shall see. Rarely has
        mimicry been used to such high-level hermeneutic ends.” <strong>Johanna Drucker</strong>
      </p>
      ...
      <ul className="bullet-list">
        ...
        <li>
          Hajnoczky, Helen. “<a href="https://www.ateacozyisasometimes.com/blog/2020/4/30/229mn1s4ah8xrzknyqlmupb2ila3kn">OOH My Heart</a>
      ...
      <ul className="bullet-list">
        ...
        <li>
          “Table of Contents (for Gary Barwin).” Spectral Lines, An anthology of visual poems, edited by Kyle Flemmer. League of Canadian
          Poets.
        </li>
        <li>
        ...
        <li>
          “I am Here” and “See No Ideas, Hear No Ideas.” <em>14 Ways of Being Kinder to the Earth</em>, edited by Gregory Betts and derek
          beaulieu, pp. 14-15 (co-authored with Marianne Holm Hansen). 2021
        </li>
        <li>
        ...
        <li>
          “Antigone,” “Hestia,” “Medea,” “Ariadne,” and “Semele.” <em>Explorations in Media Ecology</em>, ed. Adeena Karasick, vol. 20, no.
          2, 2021
        </li>
        <li>
        ...
        <li>
          “Megara” and “Eurydice.” <em>Myth &amp; Metamorphosis</em>, eds. Anthony Etherin and Clara Daneri, Penteract Press, 2020, p. 28
        </li>
        <li>
        ...
        <li>
          <a>“Mirella Bentivoglio,” “Ruth Wolf-Rehfeldt,” “Eric Schmaltz,” “Franz Mon,” “Nico Vassilakis.”</a> <em>Touch the Donkey, </em>
          iss. 18, July 2018
        </li>
        <li>
        ...
        <li>
          “John Riddell,” “Zdenek Barborka,” “Marianne Holm Hansen,” “Cavan McCarthy,” “Jiri Valoch,” “Shant Basmajian,” and “M. Hachette.”{' '}
        ...
        <li>
          <a href="http://themaynard.org/Vol10No2/contents.php">“Errata,” “Unrest,” and “Rebelling.”</a> <em>The Maynard</em>, Fall 2017.
        </li>
        <li>
      ...
      <ul className="bullet-list">
        ...
        <li>
          “coding practice” and “rebelling” (Russian translations by Pavel Zarutskiy). <em>Type-In Exhibit of Typewriter Poetry</em>, St.
