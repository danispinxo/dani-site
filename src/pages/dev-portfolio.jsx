...
export default function Portfolio() {
  const images = [
    { src: '/images/lighthouse.jpg', alt: 'Lighthouse Labs Web Development Bootcamp' },
    { src: '/images/pmi.jpg', alt: 'Project Management Institute: CAPM' },
    { src: '/images/python-fundamentals.jpg', alt: 'Udemy: Python Fundamentals' },
    { src: '/images/complete-python.jpg', alt: 'Udemy: The Complete Python Developer' },
    { src: '/images/python-django.jpg', alt: 'Udemy: Python Django - The Practical Guide' },
  ];
