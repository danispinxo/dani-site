    ...
    <>
      ...
      <main className="page-content">
        <div className="text">
          ...
          <p className="when-line">
            When the {selectRandomString(lights)} went{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the
            darkness turned on
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} went{" "}
          ...
          <p className="when-line">
            When the {selectRandomString(lights)} went{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
            {selectRandomString(darkness)} {selectRandomString(turnedOn)} us and
            our unchecked love
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} went{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
            {selectRandomString(darkness)} {selectRandomString(turnedOn)} us and
            our {selectRandomString(uncheckedLove)} of dandelions
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} went{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
            {selectRandomString(darkness)} {selectRandomString(turnedOn)} us and
            our {selectRandomString(uncheckedLove)} of{" "}
            {selectRandomString(dandelions)} did nothing
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
            {selectRandomString(darkness)} {selectRandomString(turnedOn)} us and
            our {selectRandomString(uncheckedLove)} of{" "}
          ...
          <p className="when-line">
            ...
            {selectRandomString(darkness)} {selectRandomString(turnedOn)} us and
            our {selectRandomString(uncheckedLove)} of{" "}
            {selectRandomString(dandelions)} did nothing to save them from our
            unchecked love
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            ...
            our {selectRandomString(uncheckedLove)} of{" "}
            {selectRandomString(dandelions)} did nothing to save them from our{" "}
            {selectRandomString(uncheckedLoveTwo)} of the darkness
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
          ...
          <p className="when-line">
            ...
            {selectRandomString(darknessTwo)} inside the{" "}
            {selectRandomString(eternalImmanence)} we{" "}
            {selectRandomString(considered)} and refused to believe was alive
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
          ...
          <p className="when-line">
            ...
            {selectRandomString(eternalImmanence)} we{" "}
            {selectRandomString(considered)} and refused to believe was{" "}
            {selectRandomString(alive)} and {selectRandomString(lurking)} in the
            light
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            ...
            {selectRandomString(considered)} and refused to believe was{" "}
            {selectRandomString(alive)} and {selectRandomString(lurking)} in the{" "}
            {selectRandomString(light)} as much as the dark
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
            ...
            {selectRandomString(considered)} and refused to believe was{" "}
            {selectRandomString(alive)} and {selectRandomString(lurking)} in the{" "}
            {selectRandomString(light)} as much as the dark-haired stranger
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
            ...
            {selectRandomString(considered)} and refused to believe was{" "}
            {selectRandomString(alive)} and {selectRandomString(lurking)} in the{" "}
            {selectRandomString(light)} as much as the{" "}
          ...
          <p className="when-line">
            ...
            {selectRandomString(darkHairedStranger)} we{" "}
            {selectRandomString(greeted)} with{" "}
            {selectRandomString(mutteredFrenchAndGerman)} widows knitted us
            blankets
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
          ...
          <p className="when-line">
            ...
            {selectRandomString(mutteredFrenchAndGerman)} widows{" "}
            {selectRandomString(knittedUsBlankets)} of{" "}
            {selectRandomString(kidHair)} that {selectRandomString(blanketed)}{" "}
            the {selectRandomString(blankness)}
          </p>
          <p className="when-line">
            When the {selectRandomString(lights)} {selectRandomString(went)}{" "}
            {selectRandomString(wordOut)} and {selectRandomString(before)} the{" "}
            ...
            {selectRandomString(knittedUsBlankets)} of{" "}
            {selectRandomString(kidHair)} that {selectRandomString(blanketed)}{" "}
            the {selectRandomString(blankness)} when the lights went out
          </p>
        </div>
      </main>
    </>
