    ...
    <>
      ...
      <main className="page-content">
        ...
        <div className="text">
          ...
          <p>
            “I'm so glad this book exists—for what it means not only to me to
            read it now, but for what it will mean to others who are looking for
            a way into vispo that speaks to them and their lives. I love that it
            exists for the people who are going to be totally blown away by
            Spinosa and Siklosi's conversation, having never read anything quite
            like that before. This book is a real gift to vispo, its fans and
            ...
            is conceptually radical, formally daring, and stylistically
            wonderful—as smart and imaginative as anything one should by now
            expect of Spinosa.”{" "}
            <strong>
          ...
          <p>
            “This collection is both Spinosa's personal study in the history of
            visual and concrete poetry as well as a collection of original
            works… She's clearly done her research, and if one were even to put
            together an anthology of or essay on the history of concrete and
            visual poetries, this would be the list of names included. Or, given
            Spinosa's deliberate inclusion of these multiple women
            practitioners, this is the list of names that should be included;
            and hopefully, in part through Spinosa's work, a list of names that
            will no longer be overlooked.” <strong>rob mclennan</strong>
          </p>
          <p>
            “Because the glosa, which builds a highly structured rhyming poem
            around a seed quatrain from a source text, is firmly rooted in the
            lyric, Spinosa has to find other ways to both quote and write
            through or around or over her sources. As she acknowledges in the
            introduction, even quoting a line from a concrete poem, much less an
            entire quatrain, can prove difficult as visual forms tend to
            challenge the convention of the line, but she more than manages this
            feat. The poems in the collection capture the aesthetics, the feel,
            of the texts they reference. Perhaps more importantly though,
            Spinosa's intervention in those texts unifies them.&nbsp;
            <em>OO</em>&nbsp;reads as a collection not an anthology with its
            poet, in the spirit of the glosa, paying tribute to influences and
            inspiration.” <strong>Ryan J. Cox, Prairie Fire</strong>
          </p>

          <p>
            “Dani Spinosa's OO pushes buttons, turns keys, and swipes, steals
            and homages all over poetry. Every poem demands you LOOK AGAIN! and
            see where voices slip between the keystrokes. Extravagant,
            interruptive, declarative and a real kick in the eyeballs.”{" "}
            <strong>derek beaulieu</strong>
          </p>

          <p>
            “WTF does Dani Spinosa think she is doing copying all these (mostly)
            male poets? Lock up your typewriters! Hide your anthologies of
            classic visual poetry! Protect yourself and the literary tradition
            from the stealth interventions of Spinosa, who is (mis)appropriating
            works by every conceivable author of graphically scored verse in the
            name of some kind of femmeship that involves conversations with the
            dead as well as the living. The former are silent on the matter and
            the latter? We shall see. Rarely has mimicry been used to such
            high-level hermeneutic ends.” <strong>Johanna Drucker</strong>
          </p>

          <p>
            “Not only an excellent, well-researched overview of the history and
            tradition of typewritten visual poetry, but also—what a sly female
            response to it!” <strong>Petra Schulze-Wollgast</strong>
          </p>
          <p className="heading">
          ...
          <ul className="bullet-list">
            ...
            <li>
              Beattie, Stephen. “In her new collection, Dani Spinosa locates
              visual poetry at the nexus of analogue and digital traditions.”{" "}
              <em>Quill &amp; Quire</em>, 2 June.
            </li>
            <li>
              Beattie, Stephen. “<em>OO: Typewriter Poems</em>.”{" "}
              <em>Quill &amp; Quire</em>, vol. 86, iss. 1, Febr/uary 2020, p.
              18.
            </li>
            <li>
              Ball, Jonathan. “
        ...
        <div className="text">
          ...
          <ul className="bullet-list">
            ...
            <li>
              Swatch.” <i>ADDA</i>, vol.1, edited by Renaat Ramon and Andreas
              van Roompaey, pp. 14-18, 2025.
            </li>
            <li>
              “
              ...
              .” <i>Taper</i>, vol. 13, special issue on Superstitions, 2024.
            </li>
            <li>
            ...
            <li>
              “Park and Fly.”{" "}
              <i>
                Extrins: 13 responses by poets of note to Kevin Stebner's book
              </i>{" "}
              Inherent, 2024.
            </li>
            <li>
              “Shadows Cast by Moonlight,” in “Incantations” by Brandon Hocura
              and Naomi Okabe, <i>PUBLIC Art|Culture|Ideas</i>, issue 69, edited
              by Tamara de Szecheo Lang, Emily Pelstring, and Dan Vena, 2024.
            </li>
            <li>
              “Two poems,”{" "}
            ...
            <li>
              “Flowers for Helen.” <em>Report from the Hajnosczky Society</em>,
              edited by rob mclennan, 2022.
            </li>
            <li>
              “New Noise.” <em>Report from the Siklosi Society</em>, edited by
              rob mclennan, 2022.
            </li>
            <li>
              <a
            ...
            <li>
              “Noi Peccatori.” <em>Report from the Earl Society</em>, edited by
              rob mclennan.
            </li>
            <li>
              “I am Here” and “See No Ideas, Hear No Ideas.”{" "}
              <em>14 Ways of Being Kinder to the Earth</em>, edited by Gregory
              Betts and derek beaulieu, pp. 14-15 (co-authored with Marianne
              Holm Hansen). 2021
            </li>
            <li>
              <a
            ...
            <li>
              “Shadows Cast by Moonlight.” <em>Incantations</em>, visual poem
              with audio spell accompaniment by Gavilan Rayna Russom. Séance
              Centre. 2021
            </li>
            <li>
            ...
            <li>
              ...
              <em>Explorations in Media Ecology</em>, ed. Adeena Karasick, vol.
              20, no. 2, 2021
            </li>
            <li>
              “Nausicaa” and “Glauke.” <em>Belfield Literary Review</em>, edited
              by Gregory Betts and
              <br />
              Lucy Collins, 2021
            </li>
            <li>
            ...
            <li>
              “Simply Black and White (5 Poems).” <em>Exile Quarterly</em>, vol.
              43, iss. 3, 2020, pp. 69-73.
            </li>
            <li>
              “Megara” and “Eurydice.” <em>Myth &amp; Metamorphosis</em>, eds.
              Anthony Etherin and Clara Daneri, Penteract Press, 2020, p. 28
            </li>
            <li>
              “
            ...
            <li>
              “I'm a nation, too.”{" "}
              <em>Here Comes Everyone: An Instanthology</em>, edited by Andrew
              MacEwan, p. 24, 25 April 2019
            </li>
            <li>
              “Philomela.” <em>ToCall: Women in Concrete</em>, vol. 4, edited by
              psw, 2019
            </li>
            <li>
              “Selections from <em>Betical</em> for Jon.” <em>ToCall</em>, vol.
              3, p. 3, March, 2019
            </li>
            <li>
              “from <em>Anxious Influence: Reading John Cage Theoretically</em>:
              Introduction, 1837, 1874, 1914, and Conclusion.”{" "}
              <em>Avant Canada: Poets, Prophets, Revolutionaries</em>, edited by
              Gregory Betts and Christian Bok, 2019
            </li>
            <li>
              <a>
                “Mirella Bentivoglio,” “Ruth Wolf-Rehfeldt,” “Eric Schmaltz,”
                “Franz Mon,” “Nico Vassilakis.”
              </a>{" "}
            ...
            <li>
              “John Riddell,” “Zdenek Barborka,” “Marianne Holm Hansen,” “Cavan
              McCarthy,” “Jiri Valoch,” “Shant Basmajian,” and “M. Hachette.”{" "}
              <em>Ottawater</em>, no. 14, January 2018, pp. 25-27.
            </li>
            <li>
          ...
          <ul className="bullet-list">
            <li>
              “Dangerously Close to Meaning,” co-authored with Eric Schmaltz and
              Kate Siklosi, installation in York University English Department
              Offices, installed 2019
            </li>

            <li>
              “coding practice” and “rebelling” (Russian translations by Pavel
              Zarutskiy). <em>Type-In Exhibit of Typewriter Poetry</em>, St.
              Petersburg, Russia, 2019
            </li>
            ...
            <li>
              ...
              University of Waterloo Critical Media Lab annual symposium, 7
              April 2017
            </li>
          </ul>
        </div>
