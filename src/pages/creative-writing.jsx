    ...
    <>
      ...
      <main className="page-content">
        ...
        <p>
          ...
          works… She's clearly done her research, and if one were even to put together an anthology of or essay on the history of concrete
          and visual poetries, this would be the list of names included. Or, given Spinosa's deliberate inclusion of these multiple women
        ...
        <p>
          ...
          the introduction, even quoting a line from a concrete poem, much less an entire quatrain, can prove difficult as visual forms tend
          to challenge the convention of the line, but she more than manages this feat. The poems in the collection capture the aesthetics,
          the feel, of the texts they reference. Perhaps more importantly though, Spinosa's intervention in those texts unifies them.&nbsp;
