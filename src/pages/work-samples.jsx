...
export default function WorkSamples() {
  ...
  const screenshots = [
    { src: '/images/sher1.png', alt: 'Slate (D2L Brightspace) Screenshot (Sheridan College)' },
    { src: '/images/sher2.png', alt: 'Slate (D2L Brightspace) Screenshot (Sheridan College)' },
    { src: '/images/sher3.png', alt: 'Slate (D2L Brightspace) Screenshot (Sheridan College)' },
    { src: '/images/trent1.png', alt: 'Blackboard Screenshot (Trent University)' },
    { src: '/images/trent2.png', alt: 'Blackboard Screenshot (Trent University)' },
    { src: '/images/trent3.png', alt: 'Blackboard Screenshot (Trent University)' },
  ];
      ...
      <main>
        <div className="page-content">
          ...
          <video controls autoPlay loop muted width="50%">
            <source src={'/images/sher-course-tour.mov'} type="video/mp4"></source>
          </video>
