      ...
      <main>
        <div className="page-content">
          <div className="page-container">
            ...
            <section className="writing-section">
              <h2 className="section-title">Edited Volumes</h2>
              <div className="books-grid">
                <Book
            ...
            <section className="writing-section">
              <h2 className="section-title">Scholarly Podcasts</h2>
              <div className="books-grid">
                <Book
            ...
            <section className="writing-section">
              ...
              <div className="publications-grid">
                ...
                />
                <Publication
                  title="Nations of Touch: The Politics of Electronic Literature as Digital Humanities"
            ...
            <section className="writing-section">
              ...
              <div className="publications-grid">
                ...
                />
                <Publication
                  title="Designing and Resisting: Rev. of Debates in the Digital Humanities 2019 by Matthew K. Gold and Lauren F. Klein (Editors)"
                  publication="Canadian Literature"
                ...
                />
                <Publication
                  title="Tired Time Travelling: Rev. of Traversing Leonard by Craig Savel"
                  publication="Canadian Literature"
